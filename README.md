...
Текущие voice flow и billing этот сервис не меняет.
...
- `📋 HR Summary` - краткое HR-резюме заметки без финальных кадровых решений.
- `🧠 Competency Notes` - наблюдения по компетенциям с evidence,
  интерпретацией, уровнем уверенности и вопросами для уточнения.
- `⚖️ Evidence` - разделение наблюдаемых фактов, гипотез, недостающих данных и
  рисков необоснованных выводов.
- `🧾 HR Report` - черновик assessment report с контекстом, наблюдениями,
